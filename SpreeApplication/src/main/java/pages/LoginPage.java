...
public class LoginPage {
	...
	@FindBy(xpath = "//h3[contains(text(),'Login as Existing Customer')]")
	WebElement existingCustomerLogin;
    ...
    public String existingCustomerMsg()
    {
    	String existingCustomermsg = existingCustomerLogin.getText();
    	return existingCustomermsg;
    }
